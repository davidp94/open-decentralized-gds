      ...
      <main className="container">
        <div className="pure-g">
          <div className="pure-u-1-1 header">
            ...
            <h1>Flight Inventory Manager</h1>
          ...
          <div className="pure-u-1-1">
            ...
            <br />
            <h2>FlightInventory Information</h2>
            <p>
              Address: {this.drizzle.contracts.FlightInventory.address}
            </p>
            <p>
              Total Delay: <ContractData contract="FlightInventory" method="getTotalDelay" />
            </p>
